...
var helsinki1952Adatok:helsinkielem[]=Objektumfeltolto(eredmenyek);
...
var pontszerzoHelyekSzama:number=helsinki1952Adatok.length;

console.log("3.feladat:")
console.log("Pontszerző helyezések száma:"+pontszerzoHelyekSzama);

function ErmekSzama(adatok:helsinkielem[]):void{
    var arany:number=0;
    var ezust:number=0;
    var bronz:number=0;
...
function olimpiaiPontokSzama(adatok:helsinkielem[]):void{
    var elso:number=0;
    var masodik:number=0;
    var harmadik:number=0;
    var negyedik:number=0;
    var otodik:number=0;
    var hatodik:number=0;
    ...
    var olimpiaiPontokSzama:number=elso*7+masodik*5+harmadik*4+negyedik*3+otodik*2+hatodik*1;
